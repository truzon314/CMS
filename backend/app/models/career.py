...
class Career(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    employment_type: Mapped[str | None] = mapped_column("employmentType", String(100), default=None)
    description: Mapped[str] = mapped_column(Text, nullable=False)
    apply_email: Mapped[str | None] = mapped_column("applyEmail", String(255), default=None)
