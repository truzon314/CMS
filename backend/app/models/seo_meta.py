...
class SeoMeta(UUIDPrimaryKeyMixin, Base):
    ...
    twitter_title: Mapped[str | None] = mapped_column(String(255), default=None)
    twitter_description: Mapped[str | None] = mapped_column(String(500), default=None)
    twitter_image_media_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), default=None)
