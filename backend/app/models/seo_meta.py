...
class SeoMeta(UUIDPrimaryKeyMixin, Base):
    ...
    focus_keyword: Mapped[str | None] = mapped_column(String(255), default=None)
    ...
    og_image_media_id: Mapped[str | None] = mapped_column("ogImageId", String(255), default=None)
    twitter_card_type: Mapped[str | None] = mapped_column("twitterCard", String(50), default=None)
    ...
    twitter_image_media_id: Mapped[str | None] = mapped_column("twitterImageId", String(255), default=None)
