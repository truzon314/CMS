...
export function SeoSettingsForm({ settings, isSaving, onSave }: SeoSettingsFormProps) {
  const [draft, setDraft] = useState({
    ...
    twitter_card_default_type: settings.twitter_card_default_type ?? "summary_large_image",
  ...
  useEffect(() => {
    ...
    setOgMediaId(settings.og_default_image_media_id);
    setOgUrlOverride(null);
  }, [settings]);
  ...
  return (
    <div className="flex max-w-2xl flex-col gap-3">
      <TextField
        ...
        maxLength={255}
        value={draft.default_meta_title}
      ...
      <TextField
        ...
        value={draft.default_canonical_url}
        onChange={(e) => set("default_canonical_url", e.target.value)}
      />
      <TextField
      ...
      <ImagePickerField
        ...
        mediaId={ogMediaId}
        imageUrl={ogUrlOverride}
        onChange={({ url, mediaId }) => {
          setOgUrlOverride(url);
          setOgMediaId(mediaId);
        }}
      />
      <label className="flex flex-col gap-1.5 text-sm">
        <span>Default Twitter card</span>
        <select
          className="h-9 rounded-md border bg-white px-2"
          value={draft.twitter_card_default_type}
          onChange={(e) => set("twitter_card_default_type", e.target.value)}
        >
      ...
      <TextField
        ...
        value={draft.google_verification_code}
        onChange={(e) => set("google_verification_code", e.target.value)}
      />
      <TextField
        id="bing_verification_code"
        label="Bing verification code"
        value={draft.bing_verification_code}
        onChange={(e) => set("bing_verification_code", e.target.value)}
      />
      <TextField
        id="google_search_console_verification"
        label="Google Search Console verification"
        value={draft.google_search_console_verification}
      ...
      <TextField
        ...
        value={draft.google_tag_manager_id}
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <Textarea
          ...
          rows={8}
          value={draft.robots_txt_content}
          placeholder="User-agent: *\nAllow: /\nSitemap: https://example.com/sitemap.xml"
          onChange={(e) => set("robots_txt_content", e.target.value)}
        />
      </div>
      <TextField
        id="working_hours"
      ...
      <Button
        ...
        onClick={() =>
          onSave({
            ...
            og_default_image_media_id: ogMediaId,
          })
        }
      >
